...
public class VoitureApplication {
	...
	CommandLineRunner initialiserBaseH2(VoitureRepository voitureRepository, ClientService clientService) {
		return args -> {
			...
			voitureRepository.save(new Voiture(null, "A 1 000", "Toyota", "Corolla", c2));
			voitureRepository.save(new Voiture(null, "B 1 5000", "Renault", "Megane", c2));
			voitureRepository.save(new Voiture(null, "A 15 5000", "Peugeot", "301", c1));
		};
	}
